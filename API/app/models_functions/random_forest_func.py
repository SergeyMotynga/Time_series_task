"""
Функция обработки для модели Random Forest Regressor
"""
import pandas as pd
...
def random_forest_processing(params):
    """
    Обработка запроса для Random Forest
    ...
    if use_auto_tune:
        ...
        # Обновляем hyper_params лучшими найденными
        ...
        model = RandomForestRegressor(
            ...
            max_depth=hyper_params.get("max_depth", None),
    ...
    model_params = {
        ...
        'max_depth': used_params.get("max_depth", "None"),
        'metrics': {
