"""
Функция обработки для модели Gradient Boosting Regressor
"""
import pandas as pd
import json
import numpy as np
...
def gradient_boosting_processing(params):
    """
    Обработка запроса для Gradient Boosting
    ...
    if use_auto_tune:
        ...
        model = GradientBoostingRegressor(
            ...
            max_depth=hyper_params.get("max_depth", 3),
            random_state=42
        )
    ...
    model_params = {
        ...
        'max_depth': used_params.get("max_depth", 3),
        'metrics': {
